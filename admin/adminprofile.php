...
?>
                            ...
                            <form id="submit" action="#" class="wizard-big" method="post" name="submit">
                                    <fieldset>
                                          <div class="form-group row"><label class="col-sm-2 col-form-label">Tên quản trị:</label>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Ngày đăng ký của quản trị viên:</label>
