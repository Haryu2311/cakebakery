...
<head>
    ...
    <title>Hệ thống bánh ngọt||Chỉnh sửa hình ảnh bánh</title>
            ...
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <strong>Cập nhật hình ảnh</strong>
                    </li>
                </ol>
            </div>
        </div>
    ...
    echo $msg;
                                    ...
                                    <fieldset>
                                        <div class="form-group row"><label class="col-sm-2 col-form-label">Tên mặt hàng</label>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Hình ảnh mới</label>
