...
?>
                            ...
                            <form name="changepassword" method="post" class="wizard-big" onsubmit="return checkpass();">
                                    <fieldset>
                                          <div class="form-group row"><label class="col-sm-2 col-form-label">Mật khẩu hiện tại:</label>
                                             ...
                                             <div class="form-group row"><label class="col-sm-2 col-form-label">Mật khẩu mới:</label>
                                             ...
                                             <div class="form-group row"><label class="col-sm-2 col-form-label">Xác nhận mật khẩu:</label>
          ...
          <p style="text-align: center;"><button type="submit" name="submit" class="btn btn-primary">Thay đổi</button></p>
