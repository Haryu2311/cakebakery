...
<head>
    <title>Hệ thống bánh ngọt || Bảng điều khiển</title>
...
?>
<a class="text-muted text-uppercase m-b-20" href="all-order.php" style="font-size: 20px"><strong>Tổng đơn hàng</strong></a>
                                <h5></h5>
                            </div>
...
?>
<a class="text-muted text-uppercase m-b-20" href="notconfirmedyet.php" style="font-size: 20px"><strong>Đơn hàng mới</strong></a>
...
<a class="text-muted text-uppercase m-b-20" href="cakebeingprepared.php" style="font-size: 20px"><strong>Bánh đang được chuẩn bị</strong></a>
                            ...
                            <div class="ibox-content">
                                ...
                                <small>Bánh đang được chuẩn bị</small>
                            </div>
                        </div>
            </div>
...
<a class="text-muted text-uppercase m-b-20" href="Cake-delivered.php" style="font-size: 20px"><strong>Tổng số bánh giao hàng</strong></a>
                            ...
                            <div class="ibox-content">
                                ...
                                <small>Tổng số bánh giao hàng</small>
                            </div>
                        </div>
                    </div>
...
?>
<a class="text-muted text-uppercase m-b-20" href="user-detail.php" style="font-size: 20px"><strong>Tổng số người dùng đã đăng ký</strong></a>
                         
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo $usercount;?></h1>
                                
                                <small>Tổng số người dùng đã đăng ký</small>
                            </div>
                        </div>
                    </div>
