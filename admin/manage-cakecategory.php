...
<head>
    <title>Hệ thống bánh ngọt|| Quản lý danh mục</title>
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                                 <table class="table table-bordered mg-b-0">
                                    <p style="text-align: center; color: blue;font-size: 30px">Quản lý danh mục bánh </p>
              <thead>
                <tr>
                  <th>STT</th>
                  <th>Tên danh mục</th>
...
?>
              <tbody>
                <tr>
                  ...
                  <td><a href="editcategory.php?editid=<?php echo $row['ID'];?>">Chỉnh sửa</a> |  <a href="manage-cakecategory.php?del=<?php echo $row['ID'];?>" style="color:red;" onclick="return confirm('Do you really want to delete the category?');">Xóa</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
