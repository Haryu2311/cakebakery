...
<h4 class="header-title m-t-0 m-b-30">Số lượng báo cáo</h4>
<?php
$fdate=$_POST['fromdate'];
$tdate=$_POST['todate'];
?>
<h5 align="center" style="color:blue">Báo cáo số lượng đơn hàng từ <?php echo $fdate?> đến <?php echo $tdate?></h5>
<hr />
...
<th>Tổng đơn hàng chưa được xác nhận</th>
<th>Tổng số đơn hàng đã được xác nhận</th>
<th>Tổng số đơn hàng đã bị hủy</th>
<th>Tổng số đơn hàng đang được chuẩn bị</th>
<th>Tổng số đơn hàng nhận</th>
<th>Tổng số đã giao</th>
</tr>
</thead>
<?php
