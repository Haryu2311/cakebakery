...
$y2=date("Y",$month2);
    ?>
    <h4 class="header-title m-t-0 m-b-30">Báo cáo doanh thu tháng bán hàng</h4>
<h4 align="center" style="color:blue">Báo cáo bán hàng từ <?php echo $m1."-".$y1;?> đến <?php echo $m2."-".$y2;?></h4>
<hr />
...
$fstatus='Cake Delivered';
 ?>
        <h4 class="header-title m-t-0 m-b-30">Năm báo cáo bán hàng</h4>
    <h4 align="center" style="color:blue">Báo cáo bán hàng từ <?php echo $y1;?> đến <?php echo $y2;?></h4>
<hr />
<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        <thead>
<tr>
