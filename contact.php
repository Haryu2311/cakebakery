...
<head>
        <title>Hệ thống bánh ngọt|| Liên hệ với chúng tôi</title>
       			...
       			<div class="row">
       				<div class="col-lg-7">
       					<form class="row contact_us_form" action="" method="post">
							...
							<div class="form-group col-md-12">
								<button type="submit" value="submit" name="submit" class="btn order_s_btn form-control">Xác nhận ngay</button>
							</div>
						</form>
       				</div>
